...
3. Create shortcut with 
	a. Target > `powershell.exe -WindowStyle -ExecutionPolicy Bypass -File "C:\YOURPATH\USERNAME\Documents\my-kanata-configs\run_kanata.ps1"`. 
	b. Start in > `C:\YOURPATH\USERNAME\Documents\my-kanata-configs`
